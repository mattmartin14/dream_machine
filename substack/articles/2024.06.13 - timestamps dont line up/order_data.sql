...
create table wms.order_hdr (order_id int, crt_ts datetime);

insert into wms.order_hdr values
    (1, '2024-01-01 08:05:23'),
    (2, '2024-01-03 12:16:44'),
    (3, '2024-02-05 18:01:12')
;

create table wms.order_event_dtl (order_id int, event_type int, event_desc string, event_ts datetime);

INSERT INTO wms.order_event_dtl (order_id, event_type, event_desc, event_ts) values
...
create table wms.order_event_ex (order_id int, except_ts datetime, ex_desc string);

INSERT INTO wms.order_event_ex (order_id, except_ts, ex_desc) values 
