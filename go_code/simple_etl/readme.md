...
<hr>
<h3>The Setup</h3>
For this process, we will generate a fake dataset using a previous go project i worked on found [here](https://github.com/mattmartin14/dream_machine/tree/main/go_code/fake_data). After that, the code in this program will do the following:
