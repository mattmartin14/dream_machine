...
Friend Class cExcel07
    ...
    Private Shared _new_sheet_nm As String = cParams.get_param_val("new_sheet_nm")
    Private Shared _table_nm As String = cParams.get_param_val("table_nm")
    Private Shared _use_auto_filter As String = cParams.get_param_val("use_autofilter")
    Private Shared _bold_headers As String = cParams.get_param_val("bold_headers")
    Private Shared _auto_fit_columns As String = cParams.get_param_val("autofit_cols")
    ...
    Private Shared _src_qry As String = cParams.get_param_val("src_qry")
    Private Shared _mssql_inst As String = cParams.get_param_val("mssql_inst")
    Private Shared _table_style_nm As String = cParams.get_param_val("table_style") ' "TableStyleMedium3"
    ...
    Private Shared Sub export_excel_07_data()

        Try

            Dim _file_path As String = cParams.get_param_val("file_path")
                    ...
                    If curr_sheet_nm <> _sheet_nm Then
                        For Each itm In wsPart.TableDefinitionParts
                            If itm.Table.Name = _table_nm Then
                                ...
                                Throw New ArgumentException(table_error_msg)
                            End If
                        Next
                    End If
                ...
                Using cn As New SqlClient.SqlConnection("Server= " + _mssql_inst + "; Integrated Security=  True")
                    ...
                    Using reader = cmd.ExecuteReader
                        ...
                        If _row_index >= (_XL_sheet_row_max + 1) Then
                            Dim err_msg As String = "Excel Error: Data set exceeds maximum Excel row limit of [" + _XL_sheet_row_max + "]."
